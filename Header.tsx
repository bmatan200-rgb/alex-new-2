        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              type="button"
              className="px-3 py-2 text-xs font-bold text-slate-700 bg-white hover:bg-purple-50 hover:text-purple-700 hover:border-purple-300 rounded-xl transition cursor-pointer border border-slate-200 shadow-xs flex items-center gap-1.5"
